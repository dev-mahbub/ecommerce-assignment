...
import sidebarMainLogo from "../../../../public/assets/images/logo/logo.png";
import sidebarDarkLogo from "../../../../public/assets/images/logo/logo.png";
    ...
    <>
      ...
      >
        ...
        <div className="common-scrollbar max-h-screen overflow-y-auto">
          <nav className="main-menu-container nav nav-pills flex-column sub-open mt-[60px]">
